...
2. Acquire the most recent APWorld from the [Releases Page]([https://github.com/aldelaro5/dolphin-memory-engine?tab=readme-ov-file#macos-code-signing](https://github.com/themogulAP/ArchipelagoCM/releases/)) and place the commandmission.apworld in the custom_worlds folder of your Archipelago install.
