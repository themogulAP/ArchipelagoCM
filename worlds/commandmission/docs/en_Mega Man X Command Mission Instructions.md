...
Items received in MMX Command Mission will automatically write the item into their respective inventory slots. (I.e. consumables vs weapons vs etc)
...
###### Quality of life:
- Permanent Sub Tanks.
- Turn Encounters completely off via Player options in the YAML. 
