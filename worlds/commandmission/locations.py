...
class MMXCMLocationData(NamedTuple):
  ...
  code:Optional[int]
  parent_region: str
  ram_data: Optional[MMXCMRamData] = None
...
LAGRANO_RUINS_LOCATIONS: dict[str, MMXCMLocationData] = {
  ...
  "Area 1F East 50z": MMXCMLocationData(
    ...
    ram_data=MMXCMRamData(0x804A2153, bit_position=2)
  ),
  "Area 1F East Build LE": MMXCMLocationData(
    name="Area 1F East 2", 
    code=2,
    parent_region="Lagrano Ruins",
    ram_data=MMXCMRamData(0x804A2153, bit_position=3)
  ),
  "Area 2F East Tank Energy 25": MMXCMLocationData(
    name="Area 2F East 1",
    code=3,
    parent_region="Lagrano Ruins",
    ram_data=MMXCMRamData(0x804A2153, bit_position=5)
  ),
  "Area 2F East Anti-Lock": MMXCMLocationData(
    name="Area 2F East 2",
    code=4,
    parent_region="Lagrano Ruins",
    ram_data=MMXCMRamData(0x804A2153, bit_position=6)
  ),
  "Area 2F East 50z": MMXCMLocationData(
    name="Area 2F East 3",
    code=5,
    parent_region="Lagrano Ruins",
    ram_data=MMXCMRamData(0x804A2153, bit_position=7)
  ),
