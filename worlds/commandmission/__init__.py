...
class MMXCMWorld(World):
    ...
    def create_regions(self):
        ...
        region_data = {
            ...
            # "Central Tower Boss Arena": "Central Tower Access Code", # This is handled by manual logic with the regions
    ...
    def generate_output(self, output_directory: str, **kwargs):
        ...
        mmxcm_container = MMXCMPlayerContainer(dict_output_data, patch_path, self.multiworld.player_name[self.player],
                                               self.player)
