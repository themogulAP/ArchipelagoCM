...
def get_rules_dict(world: "MMXCMWorld") -> dict[str, Any]:
    ...
    for location_name, location_data in LOCATION_TABLE.items():
        ...
        if location_name in ["East Area Stairs 4F to 5F Tank Parts", "East Area Stairs 4F to 5F Figure Token 1", "East Area Stairs 4F to 5F Figure Token 2"]:
        ...
        # Tianna Key Locations
            ...
            rules[location_name] = lambda state: state.has("Tianna Camp Access Code", player) and state.has("Tianna Key", player)
